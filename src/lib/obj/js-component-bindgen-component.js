import {
	cliBaseEnvironment as interface16,
	cliBaseExit as interface2,
	cliBasePreopens as interface8,
	cliBaseStderr as interface3,
	cliBaseStdin as interface4,
	cliBaseStdout as interface5
	...
	switch (variant6.tag) {
		case 'ok': {
			...
			const {
				...
				linkCount: v0_3,
				size: v0_4,
				dataAccessTimestamp: v0_5,
				dataModificationTimestamp: v0_6,
				statusChangeTimestamp: v0_7
			} = e;
...
function generateTypes(arg0, arg1) {
	...
	if (variant14 === null || variant14 === undefined) {
		...
		for (let i = 0; i < vec13.length; i++) {
			const e = vec13[i];
			const base = result13 + i * 16;
			const [tuple10_0, tuple10_1] = e;
	...
	const ret = exports1['generate-types'](
		ptr0,
		len0,
		variant5_0,
		variant5_1,
